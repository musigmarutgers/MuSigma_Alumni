...
export const pmdOpenPhotos = [
  ...
  { src: "/pmd-open/pmd-open-9.jpg", alt: "PMD Open alumni and chapter members gathered on the course", width: 1560, height: 1162 },
...
export const bbqPhotos = [
  { src: "/events/bbq/spring-bbq-1.png", alt: "Alumni gathered at the Spring 2026 Alumni BBQ", width: 4032, height: 3024 },
  { src: "/events/bbq/spring-bbq-2.png", alt: "Spring 2026 Alumni BBQ group photo on Senior Street", width: 4032, height: 3024 },
  { src: "/events/bbq/spring-bbq-3.png", alt: "Mu Sigma alumni reconnecting at the Spring 2026 Alumni BBQ", width: 4032, height: 3024 },
  ...
  { src: "/events/bbq/spring-bbq-6.png", alt: "Alumni at the Spring 2026 Alumni BBQ", width: 4032, height: 3024 }
];

export const homeHeroImages = [
  { src: "/pmd-open/pmd-open-9.jpg", alt: "PMD Open alumni and chapter members gathered outdoors" },
  { src: "/events/bbq/spring-bbq-2.png", alt: "Spring 2026 Alumni BBQ group photo on Senior Street" },
  { src: "/pmd-open/pmd-open-5.jpg", alt: "PMD Open sponsor table with Rutgers mascot and raffle prizes" },
  { src: "/events/bbq/spring-bbq-1.png", alt: "Alumni gathered at the Spring 2026 Alumni BBQ" },
  { src: "/pmd-open/pmd-open-1.jpg", alt: "PMD Open group riding golf carts at Rutgers University Golf Course" }
];

export const homeMomentPhotos = [
  { src: "/pmd-open/pmd-open-5.jpg", alt: "PMD Open sponsor table with Rutgers mascot and raffle prizes", width: 4032, height: 3024 },
  { src: "/events/bbq/spring-bbq-2.png", alt: "Spring 2026 Alumni BBQ group photo on Senior Street", width: 4032, height: 3024 },
  { src: "/pmd-open/pmd-open-1.jpg", alt: "PMD Open group riding golf carts at Rutgers University Golf Course", width: 4292, height: 3456 }
];
...
export const heroProofPoints = [
  { label: "PMD Open", description: "Spring 2026 recap live" },
  { label: "Alumni BBQ", description: "Senior Street photo recap" },
  { label: "Impact Fund", description: "Donations live and working" },
  { label: "Next up", description: "Anniversary and Homecoming" }
];

export const impactStats = [
  { value: "2", label: "2026 alumni moments captured" },
  { value: "Live", label: "Impact Fund donations" },
  { value: "Next", label: "Anniversary and Homecoming planning" },
...
export const alumniPathways = [
  {
    eyebrow: "Give",
    title: "Put support behind Mu Sigma",
    description: "Support service, scholarship-style awards, leadership development, and long-term chapter stability.",
    cta: "View the Impact Fund",
    href: "/impact-fund"
  },
  {
    eyebrow: "Attend",
    title: "Come back for the moments that matter",
    description: "Find PMD Open recaps, alumni cookout photos, and save-the-date moments for the year ahead.",
    cta: "Browse events",
    href: "/events"
  },
  {
  ...
  {
    eyebrow: "Read",
    title: "Catch up without digging",
...
export const updateCards = [
  {
    eyebrow: "Done so far",
    title: "PMD Open 2026",
    description: "A spring day at Rutgers University Golf Course supporting Scramble for the Kids and Embrace Kids Foundation.",
    href: "/pmd-open"
  },
  {
    eyebrow: "Done so far",
    title: "Spring 2026 Alumni BBQ",
    description: "A casual Senior Street cookout captured as a photo recap for alumni who came back and those who could not make it.",
    href: "/events#done-so-far"
  },
  {
    eyebrow: "Upcoming",
    title: "10th Year Anniversary + Homecoming",
    description: "The next public event space is ready for dates, locations, and details as soon as planning locks in.",
    href: "/events#upcoming"
  },
  {
    eyebrow: "Give",
    title: "Impact Fund",
    description: "Donations are live, with the public site giving alumni one clear place to support Mu Sigma.",
    href: "/impact-fund"
  }
];
...
export const events = [
  {
    ...
    description: "A larger anniversary moment for alumni and the people who helped build Mu Sigma across the last decade.",
...
export const newsletterIssues = [
  ...
  },
  {
    ...
    date: "Archive issue",
    description: "A concise recap of service, brotherhood, chapter milestones, and alumni participation from the fall term."
  },
  {
...
export const alumniSpotlights = [
  {
    ...
    description: "Alumni can help newer graduates and chapter members through career guidance, introductions, and practical advice."
  },
  {
    name: "Event Support",
    classYear: "Alumni pathway",
